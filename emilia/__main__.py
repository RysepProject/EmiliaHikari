    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/SilenceProjexts"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/SilenceProjexts")],
        ...
        update.effective_message.reply_text(tl(update.effective_message, "Ada yang bisa dibantu? 😊"))
